...
(defconst combobulate-rules-java 
 '(("_literal" (:*unnamed* ("null_literal" "character_literal" "hex_integer_literal" "false" "decimal_integer_literal" "true" "hex_floating_point_literal" "string_literal" "octal_integer_literal" "decimal_floating_point_literal" "binary_integer_literal"))) 
 ("_simple_type" (:*unnamed* ("generic_type" "integral_type" "void_type" "floating_point_type" "type_identifier" "boolean_type" "scoped_type_identifier"))) 
 ("_type" (:*unnamed* ("annotated_type"))) 
 ("_unannotated_type" (:*unnamed* ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("annotated_type" (:*unnamed* ("floating_point_type" "type_identifier" "marker_annotation" "scoped_type_identifier" "generic_type" "void_type" "array_type" "annotation" "boolean_type" "integral_type"))) 
 ("annotation" (:*unnamed* nil :arguments ("annotation_argument_list") :name ("identifier" "scoped_identifier"))) 
 ("annotation_argument_list" (:*unnamed* ("element_value_pair" "element_value_array_initializer" "expression" "annotation" "marker_annotation"))) 
 ("annotation_type_body" (:*unnamed* ("annotation_type_declaration" "constant_declaration" "class_declaration" "annotation_type_element_declaration" "interface_declaration" "enum_declaration"))) 
 ("annotation_type_declaration" (:*unnamed* ("modifiers") :body ("annotation_type_body") :name ("identifier"))) 
 ("annotation_type_element_declaration" (:*unnamed* ("modifiers") :dimensions ("dimensions") :name ("identifier") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type") :value ("annotation" "expression" "element_value_array_initializer" "marker_annotation"))) 
 ("argument_list" (:*unnamed* ("expression"))) 
 ("array_access" (:*unnamed* nil :array ("primary_expression") :index ("expression"))) 
 ("array_creation_expression" (:*unnamed* ("annotation" "marker_annotation") :dimensions ("dimensions" "dimensions_expr") :type ("generic_type" "integral_type" "void_type" "floating_point_type" "type_identifier" "boolean_type" "scoped_type_identifier") :value ("array_initializer"))) 
 ("array_initializer" (:*unnamed* ("expression" "array_initializer"))) 
 ("array_type" (:*unnamed* nil :dimensions ("dimensions") :element ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("assert_statement" (:*unnamed* ("expression"))) 
 ("assignment_expression" (:*unnamed* nil :left ("identifier" "array_access" "field_access") :operator nil :right ("expression"))) 
 ...
 ("catch_formal_parameter" (:*unnamed* ("catch_type" "modifiers") :dimensions ("dimensions") :name ("identifier" "underscore_pattern"))) 
 ("catch_type" (:*unnamed* ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("character_literal" (:*unnamed* nil)) 
 ("class_body" (:*unnamed* ("record_declaration" "method_declaration" "compact_constructor_declaration" "field_declaration" "enum_declaration" "annotation_type_declaration" "class_declaration" "constructor_declaration" "interface_declaration" "block" "static_initializer"))) 
 ...
 ("class_literal" (:*unnamed* ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("comment" (:*unnamed* ("line_comment" "block_comment"))) 
 ("compact_constructor_declaration" (:*unnamed* ("modifiers") :body ("block") :name ("identifier"))) 
 ("constant_declaration" (:*unnamed* ("modifiers") :declarator ("variable_declarator") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ...
 ("declaration" (:*unnamed* ("import_declaration" "record_declaration" "package_declaration" "module_declaration" "enum_declaration" "annotation_type_declaration" "class_declaration" "interface_declaration"))) 
 ("dimensions" (:*unnamed* ("annotation" "marker_annotation"))) 
 ("dimensions_expr" (:*unnamed* ("annotation" "expression" "marker_annotation"))) 
 ("do_statement" (:*unnamed* nil :body ("statement") :condition ("parenthesized_expression"))) 
 ("element_value_array_initializer" (:*unnamed* ("annotation" "expression" "element_value_array_initializer" "marker_annotation"))) 
 ("element_value_pair" (:*unnamed* nil :key ("identifier") :value ("annotation" "expression" "element_value_array_initializer" "marker_annotation"))) 
 ("enhanced_for_statement" (:*unnamed* ("modifiers") :body ("statement") :dimensions ("dimensions") :name ("identifier" "underscore_pattern") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type") :value ("expression"))) 
 ("enum_body" (:*unnamed* ("enum_body_declarations" "enum_constant"))) 
 ("enum_body_declarations" (:*unnamed* ("record_declaration" "method_declaration" "compact_constructor_declaration" "field_declaration" "enum_declaration" "annotation_type_declaration" "class_declaration" "constructor_declaration" "interface_declaration" "block" "static_initializer"))) 
 ...
 ("escape_sequence" (:*unnamed* nil)) 
 ("explicit_constructor_invocation" (:*unnamed* nil :arguments ("argument_list") :constructor ("super" "this") :object ("primary_expression") :type_arguments ("type_arguments"))) 
 ("exports_module_directive" (:*unnamed* nil :modules ("identifier" "scoped_identifier") :package ("identifier" "scoped_identifier"))) 
 ("expression" (:*unnamed* ("instanceof_expression" "unary_expression" "primary_expression" "switch_expression" "lambda_expression" "cast_expression" "ternary_expression" "assignment_expression" "binary_expression" "update_expression"))) 
 ("expression_statement" (:*unnamed* ("expression"))) 
 ("extends_interfaces" (:*unnamed* ("type_list"))) 
 ("false" (:*unnamed* nil)) 
 ("field_access" (:*unnamed* ("super") :field ("identifier" "this") :object ("super" "primary_expression"))) 
 ("field_declaration" (:*unnamed* ("modifiers") :declarator ("variable_declarator") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("finally_clause" (:*unnamed* ("block"))) 
 ...
 ("formal_parameter" (:*unnamed* ("modifiers") :dimensions ("dimensions") :name ("identifier" "underscore_pattern") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("formal_parameters" (:*unnamed* ("spread_parameter" "formal_parameter" "receiver_parameter"))) 
 ("generic_type" (:*unnamed* ("type_identifier" "type_arguments" "scoped_type_identifier"))) 
 ...
 ("import_declaration" (:*unnamed* ("asterisk" "scoped_identifier" "identifier"))) 
 ...
 ("interface_body" (:*unnamed* ("annotation_type_declaration" "constant_declaration" "record_declaration" "class_declaration" "method_declaration" "interface_declaration" "enum_declaration"))) 
 ("interface_declaration" (:*unnamed* ("extends_interfaces" "modifiers") :body ("interface_body") :name ("identifier") :permits ("permits") :type_parameters ("type_parameters"))) 
 ("labeled_statement" (:*unnamed* ("identifier" "statement"))) 
 ("lambda_expression" (:*unnamed* nil :body ("expression" "block") :parameters ("identifier" "inferred_parameters" "formal_parameters"))) 
 ("line_comment" (:*unnamed* nil)) 
 ("local_variable_declaration" (:*unnamed* ("modifiers") :declarator ("variable_declarator") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ("marker_annotation" (:*unnamed* nil :name ("identifier" "scoped_identifier"))) 
 ("method_declaration" (:*unnamed* ("annotation" "marker_annotation" "throws" "modifiers") :body ("block") :dimensions ("dimensions") :name ("identifier") :parameters ("formal_parameters") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type") :type_parameters ("type_parameters"))) 
 ("method_invocation" (:*unnamed* ("super") :arguments ("argument_list") :name ("identifier") :object ("super" "primary_expression") :type_arguments ("type_arguments"))) 
 ("method_reference" (:*unnamed* ("super" "type_arguments" "annotated_type" "primary_expression"))) 
 ("modifiers" (:*unnamed* ("annotation" "marker_annotation"))) 
 ("module_body" (:*unnamed* ("module_directive"))) 
 ("module_declaration" (:*unnamed* ("annotation" "marker_annotation") :body ("module_body") :name ("identifier" "scoped_identifier"))) 
 ("module_directive" (:*unnamed* ("uses_module_directive" "requires_module_directive" "opens_module_directive" "exports_module_directive" "provides_module_directive"))) 
 ("multiline_string_fragment" (:*unnamed* nil)) 
 ("null_literal" (:*unnamed* nil)) 
 ("object_creation_expression" (:*unnamed* ("annotation" "class_body" "marker_annotation" "primary_expression") :arguments ("argument_list") :type ("generic_type" "integral_type" "void_type" "floating_point_type" "type_identifier" "boolean_type" "scoped_type_identifier") :type_arguments ("type_arguments"))) 
 ...
 ("package_declaration" (:*unnamed* ("annotation" "scoped_identifier" "marker_annotation" "identifier"))) 
 ("parenthesized_expression" (:*unnamed* ("expression"))) 
 ("pattern" (:*unnamed* ("record_pattern" "type_pattern"))) 
 ("permits" (:*unnamed* ("type_list"))) 
 ("primary_expression" (:*unnamed* ("null_literal" "method_invocation" "array_access" "parenthesized_expression" "hex_integer_literal" "method_reference" "identifier" "decimal_integer_literal" "hex_floating_point_literal" "true" "array_creation_expression" "binary_integer_literal" "decimal_floating_point_literal" "character_literal" "object_creation_expression" "template_expression" "false" "this" "field_access" "class_literal" "string_literal" "octal_integer_literal"))) 
 ("program" (:*unnamed* ("statement" "method_declaration"))) 
 ...
 ("receiver_parameter" (:*unnamed* ("identifier" "floating_point_type" "type_identifier" "marker_annotation" "scoped_type_identifier" "this" "generic_type" "void_type" "array_type" "annotation" "boolean_type" "integral_type"))) 
 ...
 ("record_pattern" (:*unnamed* ("identifier" "generic_type" "record_pattern_body"))) 
 ("record_pattern_body" (:*unnamed* ("record_pattern" "record_pattern_component"))) 
 ("record_pattern_component" (:*unnamed* ("identifier" "floating_point_type" "type_identifier" "underscore_pattern" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ...
 ("resource" (:*unnamed* ("identifier" "modifiers" "field_access") :dimensions ("dimensions") :name ("identifier" "underscore_pattern") :type ("floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type") :value ("expression"))) 
 ...
 ("scoped_type_identifier" (:*unnamed* ("generic_type" "annotation" "type_identifier" "marker_annotation" "scoped_type_identifier"))) 
 ("spread_parameter" (:*unnamed* ("floating_point_type" "type_identifier" "variable_declarator" "scoped_type_identifier" "generic_type" "void_type" "array_type" "modifiers" "boolean_type" "integral_type"))) 
 ("statement" (:*unnamed* ("continue_statement" "enhanced_for_statement" "return_statement" "declaration" "try_statement" "if_statement" "for_statement" "labeled_statement" "try_with_resources_statement" "break_statement" "expression_statement" "block" "switch_expression" "yield_statement" "while_statement" "assert_statement" "local_variable_declaration" "do_statement" "throw_statement" "synchronized_statement"))) 
 ("static_initializer" (:*unnamed* ("block"))) 
 ("string_fragment" (:*unnamed* nil)) 
 ("string_interpolation" (:*unnamed* ("expression"))) 
 ("string_literal" (:*unnamed* ("multiline_string_fragment" "string_interpolation" "string_fragment" "escape_sequence"))) 
 ("super" (:*unnamed* nil)) 
 ("super_interfaces" (:*unnamed* ("type_list"))) 
 ("superclass" (:*unnamed* ("annotated_type"))) 
 ("switch_block" (:*unnamed* ("switch_rule" "switch_block_statement_group"))) 
 ...
 ("switch_label" (:*unnamed* ("expression" "guard" "pattern"))) 
 ("switch_rule" (:*unnamed* ("switch_label" "throw_statement" "expression_statement" "block"))) 
 ...
 ("true" (:*unnamed* nil)) 
 ("try_statement" (:*unnamed* ("catch_clause" "finally_clause") :body ("block"))) 
 ("try_with_resources_statement" (:*unnamed* ("catch_clause" "finally_clause") :body ("block") :resources ("resource_specification"))) 
 ("type_arguments" (:*unnamed* ("annotated_type" "wildcard"))) 
 ("type_bound" (:*unnamed* ("annotated_type"))) 
 ("type_identifier" (:*unnamed* nil)) 
 ("type_list" (:*unnamed* ("annotated_type"))) 
 ("type_parameter" (:*unnamed* ("annotation" "type_identifier" "marker_annotation" "type_bound"))) 
 ("type_parameters" (:*unnamed* ("type_parameter"))) 
 ("type_pattern" (:*unnamed* ("identifier" "floating_point_type" "type_identifier" "scoped_type_identifier" "generic_type" "void_type" "array_type" "boolean_type" "integral_type"))) 
 ...
 ("variable_declarator" (:*unnamed* nil :dimensions ("dimensions") :name ("identifier" "underscore_pattern") :value ("expression" "array_initializer"))) 
 ("void_type" (:*unnamed* nil)) 
 ("while_statement" (:*unnamed* nil :body ("statement") :condition ("parenthesized_expression"))) 
 ("wildcard" (:*unnamed* ("annotation" "marker_annotation" "super" "annotated_type"))) 
...
(defconst combobulate-rules-java-inverse 
 '(("annotated_type" ("instanceof_expression" "_type" "type_list" "method_reference" "superclass" "cast_expression" "type_bound" "throws" "wildcard" "type_arguments"))
   ("annotation" ("type_parameter" "element_value_pair" "element_value_array_initializer" "annotation_argument_list" "method_declaration" "object_creation_expression" "package_declaration" "dimensions" "module_declaration" "annotated_type" "receiver_parameter" "annotation_type_element_declaration" "modifiers" "wildcard" "dimensions_expr" "array_creation_expression" "scoped_type_identifier"))
   ("annotation_argument_list" ("annotation"))
   ("annotation_type_body" ("annotation_type_declaration"))
   ("annotation_type_declaration" ("class_body" "enum_body_declarations" "interface_body" "annotation_type_body" "declaration"))
   ("annotation_type_element_declaration" ("annotation_type_body"))
   ("argument_list" ("method_invocation" "explicit_constructor_invocation" "object_creation_expression" "enum_constant"))
   ("array_access" ("assignment_expression" "primary_expression"))
   ("array_creation_expression" ("primary_expression"))
   ("array_initializer" ("variable_declarator" "array_creation_expression" "array_initializer"))
   ("array_type" ("resource" "constant_declaration" "enhanced_for_statement" "method_declaration" "catch_type" "type_pattern" "record_pattern_component" "field_declaration" "_unannotated_type" "spread_parameter" "array_type" "receiver_parameter" "annotation_type_element_declaration" "class_literal" "local_variable_declaration" "formal_parameter" "annotated_type"))
   ("assert_statement" ("statement"))
   ("assignment_expression" ("expression"))
   ("asterisk" ("import_declaration"))
   ("binary_expression" ("expression"))
   ("binary_integer_literal" ("_literal" "primary_expression"))
   ("block" ("class_body" "method_declaration" "enum_body_declarations" "try_with_resources_statement" "statement" "switch_rule" "compact_constructor_declaration" "catch_clause" "lambda_expression" "try_statement" "static_initializer" "finally_clause" "synchronized_statement"))
   ("block_comment" ("comment"))
   ("boolean_type" ("constant_declaration" "enhanced_for_statement" "type_pattern" "annotation_type_element_declaration" "array_creation_expression" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("break_statement" ("statement"))
   ("cast_expression" ("expression"))
   ("catch_clause" ("try_with_resources_statement" "try_statement"))
   ("catch_formal_parameter" ("catch_clause"))
   ("catch_type" ("catch_formal_parameter"))
   ("character_literal" ("_literal" "primary_expression"))
   ("class_body" ("class_declaration" "object_creation_expression" "enum_constant" "record_declaration"))
   ("class_declaration" ("class_body" "enum_body_declarations" "interface_body" "annotation_type_body" "declaration"))
   ...
   ("continue_statement" ("statement"))
   ("decimal_floating_point_literal" ("_literal" "primary_expression"))
   ("decimal_integer_literal" ("_literal" "primary_expression"))
   ("declaration" ("statement"))
   ("dimensions" ("enhanced_for_statement" "method_declaration" "variable_declarator" "array_type" "annotation_type_element_declaration" "resource" "catch_formal_parameter" "formal_parameter" "array_creation_expression"))
   ("dimensions_expr" ("array_creation_expression"))
   ("do_statement" ("statement"))
   ("element_value_array_initializer" ("element_value_pair" "element_value_array_initializer" "annotation_argument_list" "annotation_type_element_declaration"))
   ...
   ("enum_declaration" ("class_body" "enum_body_declarations" "interface_body" "annotation_type_body" "declaration"))
   ("escape_sequence" ("string_literal"))
   ("explicit_constructor_invocation" ("constructor_body"))
   ("exports_module_directive" ("module_directive"))
   ("expression" ("instanceof_expression" "array_access" "enhanced_for_statement" "variable_declarator" "return_statement" "annotation_type_element_declaration" "binary_expression" "switch_label" "guard" "array_initializer" "assignment_expression" "dimensions_expr" "string_interpolation" "for_statement" "parenthesized_expression" "element_value_pair" "lambda_expression" "ternary_expression" "update_expression" "unary_expression" "element_value_array_initializer" "annotation_argument_list" "expression_statement" "yield_statement" "assert_statement" "cast_expression" "resource" "argument_list" "throw_statement"))
   ("expression_statement" ("statement" "switch_rule"))
   ("extends_interfaces" ("interface_declaration"))
   ("false" ("_literal" "primary_expression"))
   ("field_access" ("assignment_expression" "resource" "primary_expression"))
   ("field_declaration" ("class_body" "enum_body_declarations"))
   ("finally_clause" ("try_with_resources_statement" "try_statement"))
   ("floating_point_type" ("constant_declaration" "enhanced_for_statement" "type_pattern" "annotation_type_element_declaration" "array_creation_expression" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("for_statement" ("statement"))
   ("formal_parameter" ("formal_parameters"))
   ("formal_parameters" ("record_declaration" "constructor_declaration" "method_declaration" "lambda_expression"))
   ("generic_type" ("constant_declaration" "enhanced_for_statement" "type_pattern" "record_pattern" "annotation_type_element_declaration" "array_creation_expression" "scoped_type_identifier" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("guard" ("switch_label"))
   ("hex_floating_point_literal" ("_literal" "primary_expression"))
   ("hex_integer_literal" ("_literal" "primary_expression"))
   ("identifier" ("instanceof_expression" "record_declaration" "continue_statement" "enhanced_for_statement" "package_declaration" "type_pattern" "record_pattern" "marker_annotation" "variable_declarator" "compact_constructor_declaration" "annotation_type_element_declaration" "annotation" "catch_formal_parameter" "import_declaration" "requires_module_directive" "scoped_identifier" "module_declaration" "enum_constant" "enum_declaration" "field_access" "opens_module_directive" "interface_declaration" "assignment_expression" "formal_parameter" "method_invocation" "element_value_pair" "method_declaration" "exports_module_directive" "lambda_expression" "uses_module_directive" "labeled_statement" "break_statement" "primary_expression" "record_pattern_component" "provides_module_directive" "annotation_type_declaration" "class_declaration" "constructor_declaration" "inferred_parameters" "receiver_parameter" "resource"))
   ("if_statement" ("statement"))
   ("import_declaration" ("declaration"))
   ("inferred_parameters" ("lambda_expression"))
   ("instanceof_expression" ("expression"))
   ("integral_type" ("constant_declaration" "enhanced_for_statement" "type_pattern" "annotation_type_element_declaration" "array_creation_expression" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("interface_body" ("interface_declaration"))
   ("interface_declaration" ("class_body" "enum_body_declarations" "interface_body" "annotation_type_body" "declaration"))
   ("labeled_statement" ("statement"))
   ("lambda_expression" ("expression"))
   ("line_comment" ("comment"))
   ("local_variable_declaration" ("statement" "for_statement"))
   ("marker_annotation" ("type_parameter" "element_value_pair" "element_value_array_initializer" "annotation_argument_list" "method_declaration" "object_creation_expression" "package_declaration" "dimensions" "module_declaration" "annotated_type" "receiver_parameter" "annotation_type_element_declaration" "modifiers" "wildcard" "dimensions_expr" "array_creation_expression" "scoped_type_identifier"))
   ("method_declaration" ("program" "class_body" "enum_body_declarations" "interface_body"))
   ("method_invocation" ("primary_expression"))
   ("method_reference" ("primary_expression"))
   ("modifiers" ("resource" "constant_declaration" "record_declaration" "enhanced_for_statement" "method_declaration" "compact_constructor_declaration" "field_declaration" "enum_constant" "enum_declaration" "annotation_type_declaration" "class_declaration" "constructor_declaration" "spread_parameter" "annotation_type_element_declaration" "interface_declaration" "local_variable_declaration" "catch_formal_parameter" "formal_parameter"))
   ...
   ("null_literal" ("_literal" "primary_expression"))
   ("object_creation_expression" ("primary_expression"))
   ("octal_integer_literal" ("_literal" "primary_expression"))
   ("opens_module_directive" ("module_directive"))
   ("package_declaration" ("declaration"))
   ("parenthesized_expression" ("primary_expression" "switch_expression" "while_statement" "do_statement" "if_statement" "synchronized_statement"))
   ("pattern" ("switch_label"))
   ("permits" ("class_declaration" "interface_declaration"))
   ("primary_expression" ("method_invocation" "explicit_constructor_invocation" "array_access" "method_reference" "object_creation_expression" "template_expression" "field_access" "expression"))
   ("provides_module_directive" ("module_directive"))
   ("receiver_parameter" ("formal_parameters"))
   ("record_declaration" ("declaration" "class_body" "enum_body_declarations" "interface_body"))
   ("record_pattern" ("instanceof_expression" "record_pattern_body" "pattern"))
   ...
   ("return_statement" ("statement"))
   ("scoped_identifier" ("import_declaration" "requires_module_directive" "package_declaration" "exports_module_directive" "scoped_identifier" "marker_annotation" "provides_module_directive" "module_declaration" "uses_module_directive" "opens_module_directive" "annotation"))
   ("scoped_type_identifier" ("constant_declaration" "enhanced_for_statement" "type_pattern" "generic_type" "annotation_type_element_declaration" "array_creation_expression" "scoped_type_identifier" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("spread_parameter" ("formal_parameters"))
   ("statement" ("constructor_body" "enhanced_for_statement" "labeled_statement" "switch_block_statement_group" "while_statement" "do_statement" "block" "program" "if_statement" "for_statement"))
   ("static_initializer" ("class_body" "enum_body_declarations"))
   ("string_fragment" ("string_literal"))
   ("string_interpolation" ("string_literal"))
   ("string_literal" ("_literal" "template_expression" "primary_expression"))
   ("super" ("method_invocation" "explicit_constructor_invocation" "method_reference" "field_access" "wildcard"))
   ("super_interfaces" ("class_declaration" "record_declaration" "enum_declaration"))
   ("superclass" ("class_declaration"))
   ("switch_block" ("switch_expression"))
   ("switch_block_statement_group" ("switch_block"))
   ("switch_expression" ("statement" "expression"))
   ...
   ("ternary_expression" ("expression"))
   ("this" ("explicit_constructor_invocation" "receiver_parameter" "primary_expression" "field_access"))
   ("throw_statement" ("statement" "switch_rule"))
   ("throws" ("constructor_declaration" "method_declaration"))
   ("true" ("_literal" "primary_expression"))
   ("try_statement" ("statement"))
   ("try_with_resources_statement" ("statement"))
   ("type_arguments" ("method_invocation" "explicit_constructor_invocation" "method_reference" "object_creation_expression" "generic_type"))
   ("type_bound" ("type_parameter"))
   ("type_identifier" ("constant_declaration" "enhanced_for_statement" "type_pattern" "generic_type" "annotation_type_element_declaration" "array_creation_expression" "scoped_type_identifier" "local_variable_declaration" "formal_parameter" "annotated_type" "type_parameter" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("type_list" ("extends_interfaces" "permits" "super_interfaces"))
   ("type_parameter" ("type_parameters"))
   ("type_parameters" ("record_declaration" "method_declaration" "class_declaration" "constructor_declaration" "interface_declaration"))
   ("type_pattern" ("pattern"))
   ("unary_expression" ("expression"))
   ("underscore_pattern" ("enhanced_for_statement" "record_pattern_component" "variable_declarator" "resource" "catch_formal_parameter" "formal_parameter"))
   ("update_expression" ("expression"))
   ("uses_module_directive" ("module_directive"))
   ("variable_declarator" ("constant_declaration" "spread_parameter" "field_declaration" "local_variable_declaration"))
   ("void_type" ("constant_declaration" "enhanced_for_statement" "type_pattern" "annotation_type_element_declaration" "array_creation_expression" "local_variable_declaration" "formal_parameter" "annotated_type" "method_declaration" "catch_type" "field_declaration" "_unannotated_type" "_simple_type" "object_creation_expression" "record_pattern_component" "spread_parameter" "array_type" "receiver_parameter" "class_literal" "resource"))
   ("while_statement" ("statement"))
