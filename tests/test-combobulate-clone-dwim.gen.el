...
(ert-deftest combobulate-test-dockerfile-combobulate-clone-dwim--Dockerfile-shell_fragment-1 ()
 "Test `combobulate' with `fixtures/clone/Dockerfile-shell_fragment' in `dockerfile-ts-mode' mode."
	     (combobulate-test
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/clone/Dockerfile-shell_fragment")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-clone-dwim)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-with-stubbed-proffer-choices
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/Dockerfile-shell_fragment[@1~after].")))
