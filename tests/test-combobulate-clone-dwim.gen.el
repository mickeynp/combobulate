...
(ert-deftest combobulate-test-ocaml-combobulate-clone-dwim--module-1 ()
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
	     (combobulate-test
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
	       :tags
	       '(combobulate ocaml tuareg-mode combobulate-clone-dwim)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-with-stubbed-proffer-choices
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@1~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@2~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@3~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@4~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@5~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@6~after].ml")))
 ...
 "Test `combobulate' with `fixtures/clone/module.ml' in `tuareg-mode' mode."
		 ...
		 (:language ocaml :mode tuareg-mode :fixture "fixtures/clone/module.ml")
		   ...
		   (:choices
		    '(0 0 0 0))
		 (combobulate-clone-node-dwim))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-clone-dwim/module.ml[@7~after].ml")))
