...
(ert-deftest combobulate-test-java-combobulate-drag-down--example-5 ()
 "Test `combobulate' with `fixtures/sibling/example.java' in `java-ts-mode' mode."
	     (combobulate-test
		 (:language java :mode java-ts-mode :fixture "fixtures/sibling/example.java")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 5)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/example.java[@5~after].java")))))
