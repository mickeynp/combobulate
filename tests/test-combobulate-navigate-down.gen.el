...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-down--Dockerfile-env-2 ()
 "Test `combobulate' with `fixtures/down/Dockerfile-env' in `dockerfile-ts-mode' mode."
	     (combobulate-test
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/down/Dockerfile-env")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-navigate-down)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-navigate-down)
	       (combobulate-test-assert-at-marker 2)))


(ert-deftest combobulate-test-dockerfile-combobulate-navigate-down--Dockerfile-label-2 ()
 "Test `combobulate' with `fixtures/down/Dockerfile-label' in `dockerfile-ts-mode' mode."
	     (combobulate-test
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/down/Dockerfile-label")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-navigate-down)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-navigate-down)
...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-down--Dockerfile-shell_fragment-5 ()
 "Test `combobulate' with `fixtures/down/Dockerfile-shell_fragment' in `dockerfile-ts-mode' mode."
	     (combobulate-test
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/down/Dockerfile-shell_fragment")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-navigate-down)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-navigate-down)
