...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-next--Dockerfile-env-2 ()
 "Test `combobulate' with `fixtures/sibling/Dockerfile-env' in `dockerfile-ts-mode' mode."
		 ...
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/sibling/Dockerfile-env")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-navigate-next)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-navigate-next)
	       (combobulate-test-assert-at-marker 2)))


(ert-deftest combobulate-test-dockerfile-combobulate-navigate-next--Dockerfile-instructions-10 ()
...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-next--Dockerfile-label-2 ()
...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-next--Dockerfile-shell_fragment-3 ()
