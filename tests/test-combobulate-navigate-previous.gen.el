...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-previous--Dockerfile-env-1 ()
 "Test `combobulate' with `fixtures/sibling/Dockerfile-env' in `dockerfile-ts-mode' mode."
		 ...
		 (:language dockerfile :mode dockerfile-ts-mode :fixture "fixtures/sibling/Dockerfile-env")
	       :tags
	       '(combobulate dockerfile dockerfile-ts-mode combobulate-navigate-previous)
	       (combobulate-test-go-to-marker 1)
	       (combobulate-navigate-previous)
	       (combobulate-test-assert-at-marker 1)))


(ert-deftest combobulate-test-dockerfile-combobulate-navigate-previous--Dockerfile-instructions-1 ()
...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-previous--Dockerfile-label-1 ()
...
(ert-deftest combobulate-test-dockerfile-combobulate-navigate-previous--Dockerfile-shell_fragment-1 ()
