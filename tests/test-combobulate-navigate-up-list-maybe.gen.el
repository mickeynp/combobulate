...
(ert-deftest combobulate-test-tsx-combobulate-navigate-up-list-maybe--module-statements-8 ()
 "Test `combobulate' with `fixtures/up-down/module-statements.tsx' in `tsx-ts-mode' mode."
		 ...
		 (:language tsx :mode tsx-ts-mode :fixture "fixtures/up-down/module-statements.tsx")
	       :tags
	       '(combobulate tsx tsx-ts-mode combobulate-navigate-up-list-maybe)
...
(ert-deftest combobulate-test-tsx-combobulate-navigate-up-list-maybe--nested-jsx-8 ()
