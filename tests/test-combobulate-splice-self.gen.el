...
(ert-deftest combobulate-test-python-combobulate-splice-self--messy-splice-1 ()
 "Test `combobulate' with `fixtures/splice/messy-splice.py' in `python-ts-mode' mode."
		 ...
		 (:language python :mode python-ts-mode :fixture "fixtures/splice/messy-splice.py")
		   ...
		   (:choices
		    '(0 0 0 0 0 0))
		 (combobulate-splice-self))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-splice-self/messy-splice.py[@1~after].py")))
...
(ert-deftest combobulate-test-toml-combobulate-splice-self--pairs-in-table-1 ()
 "Test `combobulate' with `fixtures/splice/pairs-in-table.toml' in `toml-ts-mode' mode."
		 ...
		 (:language toml :mode toml-ts-mode :fixture "fixtures/splice/pairs-in-table.toml")
		   ...
		   (:choices
		    '(0 0 0 0 0 0))
		 (combobulate-splice-self))
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-splice-self/pairs-in-table.toml[@1~after].toml")))
